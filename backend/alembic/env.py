...
This file is run whenever Alembic migrations are executed. It imports all
models so autogenerate can detect schema changes, and reads the DATABASE_URL
from the app config.
"""
...
def run_migrations_offline() -> None:
    ...
    Engine creation we dont even need a DBAPI to be available.
